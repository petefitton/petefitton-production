  ...
  return (
    <footer className="footer">
      <ul className="footer-list">
        ...
        <li><a href="https://open.spotify.com/artist/2kOaq98e4BfVwBnEp3PRbz" aria-label="Spotify" target="_blank" rel="noreferrer"><FontAwesomeIcon className="fa" icon={faSpotify} /></a></li>
