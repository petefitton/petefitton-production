      ...
      {imagesLoaded ?
        <div className="supportpage-container pt-60">
          <div className="content-container">
            ...
            <p className="support-text">You can support me by buying my music on <a href="https://petefitton.bandcamp.com/" aria-label="Bandcamp" target="_blank" rel="noreferrer" className="supportpage-anchor">my Bandcamp page</a>, and you can also tip me directly via Wise or Venmo below. Most independent musicians make most of their money from album sales, merch, and tips, so any support beyond streaming is much appreciated. Even sharing my music with others is helpful! :)<br></br>Thank you!</p>
